...
autocmd('LspAttach', {
  ...
  callback = function(e)
    ...
    vim.keymap.set("n", "gd", function() vim.lsp.buf.definition() end, { buffer = e.buf, desc = "Goto Defenition" })
    ...
    vim.keymap.set("n", "<leader>rr", function() vim.lsp.buf.references() end, { buffer = e.buf, desc = "references" })
    vim.keymap.set("n", "<leader>rn", function() vim.lsp.buf.rename() end, { buffer = e.buf, desc = "rename" })
    vim.keymap.set("i", "<C-h>", function() vim.lsp.buf.signature_help() end, { buffer = e.buf })
